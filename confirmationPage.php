    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase" style="margin-top:140px">Thank you for your order</h2>
		  <h3 class="section-heading text-uppercase" style="margin-top:30px">We are going to process your order in the next 24 hours</h3>
        </div>
      </div>
    </div>
  </section>
